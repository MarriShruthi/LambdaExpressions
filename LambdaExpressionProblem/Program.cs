...
namespace LambdaExpressionProblem
{
    class Program
    {
        ...
        {
            personList.Add(new Person() { SSN = 1, Age = 18,  Name = "Shruthi",  Address = "Hyderabad" });
            personList.Add(new Person() { SSN = 2, Age = 28,  Name = "Swetha",   Address = "Mumbai" });
